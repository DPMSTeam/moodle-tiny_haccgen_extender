    ...
    body: {
      ...
      items: [
...

        {
          ...
          name: 'prompt',
          label: '',
          placeholder: 'E.g. Extract all text exactly as-is, preserve line breaks.',
        },
      ],
    },

    initialData: {
      prompt: 'Extract all readable text from this file. Preserve line breaks. Output only the extracted text.',
    },
